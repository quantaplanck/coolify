...
<x-layout>
  ...
  <div class="sm:flex sm:min-h-screen sm:items-center sm:justify-center">
    <div class="flex flex-col justify-center align-middle sm:flex-row gap-3">
      <div class="flex justify-center align-middle sm:w-4xl">
        <img src="{{ asset('img/rtb.jpg') }}" alt="RTB" class="w-full h-auto rounded-4xl object-contain" />
      </div>
      <div class="h-full">
        <div>
